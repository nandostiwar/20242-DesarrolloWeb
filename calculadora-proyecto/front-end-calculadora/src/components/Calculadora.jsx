    ...
    return (
        <div className="container">
            ...
            <form>
                ...
                <input type="submit" className="btnEnviar" value="numeroMayor" onClick={handleSubmit} />
                <input type="submit" className="btnEnviar" value="numeroMenor" onClick={handleSubmit} />
