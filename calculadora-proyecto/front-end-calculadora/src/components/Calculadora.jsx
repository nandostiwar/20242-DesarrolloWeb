...
function Calculadora() {
    ...
    function handleSubmit(e) {
        ...
        if (operacion == "mayor") { setResultado(parseFloat(number1) > parseFloat(number2)) }
        if (operacion == "menor") { setResultado(parseFloat(number1) < parseFloat(number2)) }
        if (operacion == "promedio") { setResultado((parseFloat(number1) + parseFloat(number2)) / 2); }
